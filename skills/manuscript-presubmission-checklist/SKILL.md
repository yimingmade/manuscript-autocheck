---
name: manuscript-presubmission-checklist
...
- Use comparison tables whenever they make discrepancies easier to verify, especially for Category 0 data consistency or any issue involving more than two locations or values.
...
The Discussion values contradict the Results section. Flag for author verification.
...
**Do not proceed to checks 1–23 until this step is fully complete.**
...
### 23. Final Layout Pass: Unnecessary Page Breaks and Spacing

As the final step, inspect the rendered document layout and the document structure for unnecessary page breaks and spacing problems. Flag, but do not silently correct:
...
- Tables, figures, captions, headings, or reference-list items separated from their related content by avoidable page breaks or spacing.
